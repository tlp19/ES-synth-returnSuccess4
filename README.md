...
|       Task        | Priority (Low to High) | Initiation  Interval <img src="https://render.githubusercontent.com/render/math?math=\tau_i" width = "10"> (ms) | Execution Time <img src="https://render.githubusercontent.com/render/math?math=T_i" width = "10"> (ms) | <img src="https://render.githubusercontent.com/render/math?math=\left[\frac{\tau_n}{\tau_i} \right] T_i" width = "60"> | CPU Utilisation (%) |
|:-----------------|:----------------------:|:-------------------------:|:-------------------:|:---------------------------------------:|:--------------------:|
